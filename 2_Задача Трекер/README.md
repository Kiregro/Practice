...
Помимо прочего, в массиве атрибуту "name" присваивается значение "cvc". Данный атрибут избыточен для трекера, поскольку его заявленное назначение - остлеживание активности пользователя.
